...
const MaterialsManager = () => {
  ...
  const loadTools = async () => {
    ...
    const toolsRef = ref(db, 'tools'); // Adjust the path as needed

    // Listen for changes to the tools
  ...
  const loadSuppliers = async () => {
    const db = getDatabase(app);
    const suppliersRef = ref(db, 'suppliers'); // Adjust the path as needed

    // Listen for changes to the suppliers
  ...
  <div className="d-flex" id="wrapper">
    ...
    <div className="sidebar" id="side_nav">
      ...
      <li
        ...
        <li
              data-tab-target="#StockMaterials"
              className={activeTab === "#StockMaterials" ? "active tab" : "tab"}
              onClick={() => handleTabClick("#StockMaterials")}
            >
              Stock Materials
            </li>

            <li
              data-tab-target="#SupplierInformation"
              className={activeTab === "#SupplierInformation" ? "active tab" : "tab"}
              onClick={() => handleTabClick("#SupplierInformation")}
            >
    ...
    <div className="content">
     ...
     {activeTab === "#dashboard" && (
          ...
          {activeTab === "#StockMaterials" && (
            <div>
              {/* Add your content for creating projects here */}
              <nav className="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
              <FontAwesomeIcon icon={faAlignLeft} className="primary-text fs-4 me-3 open-btn" />
                  <h1 className='dashboard-text'><b>Stock Materials</b></h1>
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          {activeTab === "#SupplierInformation" && (
            <div>
              {/* Add your content for creating projects here */}
              <nav className="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
              <FontAwesomeIcon icon={faAlignLeft} className="primary-text fs-4 me-3 open-btn" />
                  <h1 className='dashboard-text'><b>Supplier Information</b></h1>
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
