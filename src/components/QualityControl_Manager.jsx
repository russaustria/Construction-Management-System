...
const QualityControlManager = () => {
  ...
  const [qualitycontrolformData, setqualitycontrolformData] = useState({
    projectName: "",
    inspectionDate: "",
    inspectorName: "",
    defects: "",
  ...
  const qualitycontrolhandleSubmit = (e) => {
    e.preventDefault();

    // Replace 'qualityControlReports' with the appropriate path in your Firebase Realtime Database
    const reportsRef = ref(database, 'qualityControlReports');

    // Prepare data to push to Firebase
    const newReportData = {
      projectName: qualitycontrolformData.projectName,
      inspectionDate: qualitycontrolformData.inspectionDate,
      inspectorName: qualitycontrolformData.inspectorName,
      defects: qualitycontrolformData.defects,
      actionsTaken: qualitycontrolformData.actionsTaken,
      remarks: qualitycontrolformData.remarks,
    };
  ...
  <div className="d-flex" id="wrapper">
    ...
    <div className="sidebar" id="side_nav">
      ...
      <li
        ...
        <li
              data-tab-target="#CreateQualityControlPlan"
              className={activeTab === "#CreateQualityControlPlan" ? "active tab" : "tab"}
              onClick={() => handleTabClick("#CreateQualityControlPlan")}
            >
              Create Quality Control Plan
            </li>

            <li
              data-tab-target="#QualityControlReports"
              className={activeTab === "#QualityControlReports" ? "active tab" : "tab"}
              onClick={() => handleTabClick("#QualityControlReports")}
            >
    ...
    <div className="content">
     ...
     {activeTab === "#dashboard" && (
          ...
          {activeTab === "#CreateQualityControlPlan" && (
            <div>
              {/* Add your content for creating projects here */}
              <nav className="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
              <FontAwesomeIcon icon={faAlignLeft} className="primary-text fs-4 me-3 open-btn" />
                  <h1 className='dashboard-text'><b>Create Quality Control</b></h1>
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                  ...
                  <div className="col-lg-12">
                    <div className="card radius-10">
                      <div className="card-body">
                        <div >
                          <div>
                          <form onSubmit={qualitycontrolhandleSubmit}>
                              <div className="mb-3">
                                ...
                                <select
                                  ...
                                  id="projectName"
                                  name="projectName"
                                  value={qualitycontrolformData.projectName}
                                  onChange={(e) => setqualitycontrolformData({ ...qualitycontrolformData, projectName: e.target.value })}
                                  required
                                >
                              ...
                              <div className="mb-3">
                                ...
                                <input type="date" className="form-control" id="inspectionDate" name="inspectionDate" value={qualitycontrolformData.inspectionDate} onChange={(e) => setqualitycontrolformData({ ...qualitycontrolformData, inspectionDate: e.target.value })} required />
                              </div>

                              <div className="mb-3">
                                <label htmlFor="inspectorName" className="form-label">Inspector Name</label>
                                <input type="text" className="form-control" autoComplete="off" id="inspectorName" name="inspectorName" value={qualitycontrolformData.inspectorName} onChange={(e) => setqualitycontrolformData({ ...qualitycontrolformData, inspectorName: e.target.value })} required />
                              </div>

                              <div className="mb-3">
                                <label htmlFor="defects" className="form-label">Defects Found</label>
                                <textarea className="form-control" id="defects" name="defects" rows={4} value={qualitycontrolformData.defects} onChange={(e) => setqualitycontrolformData({ ...qualitycontrolformData, defects: e.target.value })} required />
                              </div>

                              <div className="mb-3">
                                <label htmlFor="actionsTaken" className="form-label">Actions Taken</label>
                                <textarea className="form-control" id="actionsTaken" name="actionsTaken" rows={4} value={qualitycontrolformData.actionsTaken} onChange={(e) => setqualitycontrolformData({ ...qualitycontrolformData, actionsTaken: e.target.value })} required />
                              </div>

                              <div className="mb-3">
                                <label htmlFor="remarks" className="form-label">Remarks</label>
                                <textarea className="form-control" id="remarks" name="remarks" rows={4} value={qualitycontrolformData.remarks} onChange={(e) => setqualitycontrolformData({ ...qualitycontrolformData, remarks: e.target.value })} />
                              </div>
          ...
          {activeTab === "#QualityControlReports" && (
            <div>
              {/* Add your content for creating projects here */}
              <nav className="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
              <FontAwesomeIcon icon={faAlignLeft} className="primary-text fs-4 me-3 open-btn" />
                  <h1 className='dashboard-text'><b>Quality Control Reports</b></h1>
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
