        ...
        <li
            ...
            <li className="tab">
                <div className="dropdown">
                    ...
                    <li
                    data-tab-target="#FinancialReports"
                    className={activeTab === "#FinancialReports" ? "active tab" : "tab"}
                    onClick={() => handleTabClick("#FinancialReports")}
                    >
                    Financial Reports
                    </li>
     ...
     {activeTab === "#dashboard" && (
          ...
          {activeTab === "#FinancialReports" && (
            <div>
              ...
              <nav className="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
            <FontAwesomeIcon icon={faAlignLeft} className="primary-text fs-4 me-3 open-btn" />
                  <h1 className='dashboard-text'><b>Financial Reports</b></h1>
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
